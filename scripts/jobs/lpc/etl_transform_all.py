...
if __name__ == "__main__":
    ...
    # Genes
    bf.update(
        data_sources=["hgnc"], run_steps=["transform"], force_steps=["transform"]
    )  # noqa E501
    bf.update(
        data_sources=["gene_ncbi"], run_steps=["transform"], force_steps=["transform"]
    )  # noqa E501

    # Proteins
    bf.update(
        data_sources=["pfam"], run_steps=["transform"], force_steps=["transform"]
    )  # noqa E501
    bf.update(
