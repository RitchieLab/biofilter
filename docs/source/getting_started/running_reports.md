...
- Each report has a notebook tutorial in [`notebooks_420/Templates/`](https://github.com/RitchieLab/biofilter/tree/biofilter3r/notebooks_420/Templates) — copy one and adapt it.
