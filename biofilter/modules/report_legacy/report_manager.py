...
import biofilter.modules.report_legacy.reports as reports_pkg
...
class ReportManager:
    ...
    - Reports live in: biofilter.modules.report_legacy.reports
    ...
    def _load_class(self, module_name: str) -> Type[ReportBase]:
        ...
        try:
            module = importlib.import_module(
                f"biofilter.modules.report_legacy.reports.{module_name}"
            )
