...
@local_db_uri_option
@click.option("--group", "groups", multiple=True, help="Index group (repeatable). If omitted, rebuilds all groups.")
...
@click.pass_context
def rebuild(ctx, db_uri, groups, drop_only, no_drop_first, no_write_mode, no_read_mode):
