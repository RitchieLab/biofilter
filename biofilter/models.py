...
class Namespace(Base):
    ...
    namespace_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
...
class Role(Base):
    ...
    role_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
...
class Source(Base):
    ...
    source_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
...
class Type(Base):
    ...
    type_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
...
class Warning(Base):
    ...
    warning_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
    source_id = Column(Integer, nullable=False)
...
class SnpMerge(Base):
    ...
    __table_args__ = (Index("snp_merge__merge_current", "rsMerged", "rsCurrent"),)  # noqa E501
...
class BiopolymerRegion(Base):
    ...
    __table_args__ = (
        ...
        Index("biopolymer_region__ldprofile_chr_min", "ldprofile_id", "chr", "posMin"),  # noqa E501
        Index("biopolymer_region__ldprofile_chr_max", "ldprofile_id", "chr", "posMax"),  # noqa E501
    )
...
class Group(Base):
    ...
    group_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
    type_id = Column(Integer, nullable=False)
    label = Column(String(64), nullable=False)
    description = Column(String(256))
    source_id = Column(Integer, nullable=False)
...
class GroupName(Base):
    ...
    __table_args__ = (
        ...
        Index("group_name__name_namespace_group", "name", "namespace_id", "group_id"),  # noqa E501
...
class GroupMemberName(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("group_id", "member", "type_id", "namespace_id", "name"),  # noqa E501
    )
...
class Gwas(Base):
    ...
    gwas_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
    rs = Column(Integer)
    chr = Column(Integer)
...
class Chain(Base):
    ...
    chain_id = Column(Integer, primary_key=True, autoincrement=True, nullable=False)  # noqa E501
