...
ftp://etorstenson:F5bXRV8s@dip.doe-mbi.ucla.edu/2009/tab25/Hsapi20091230.txt.gz
ftp://etorstenson:F5bXRV8s@dip.doe-mbi.ucla.edu/2009/tab25/Hsapi20091230.txt.gz
'''
...
class DIPLoader(bioloader.BioLoader):
	...
	def Load(self, force=True):
		...
		self.biosettings.CommitGroup(self.groupID, 1, "DIP", "DIP", time.strftime("%Y-%M-%d %H:%M:%S", timestamp))
