...
- 📓 **Notebook tutorials** — ready-to-run examples for every report:
  [`biofilter_legacy/bf4_420/notebooks/Templates/`](https://github.com/RitchieLab/biofilter/tree/main/biofilter_legacy/bf4_420/notebooks/Templates)
...
> [LPC deployment guide](biofilter_legacy/bf4_420/notebooks/Templates/lpc__deploy.md) for the full build
> procedure.
