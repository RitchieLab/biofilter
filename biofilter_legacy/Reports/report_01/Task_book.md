...
```dot
"loki_modules.loki_mixins.db_config_mixin.DbConfigMixin" -> "loki_modules.loki_biofilter.db.Database" [label="Config"];
"loki_modules.loki_mixins.db_liftover_mixin.DbLiftOverMixin" -> "loki_modules.loki_biofilter.db.Database" [label="LiftOver"];
"loki_modules.loki_mixins.db_operations_mixin.DbOperationsMixin" -> "loki_modules.loki_biofilter.db.Database" [label="Operations"];
"loki_modules.loki_mixins.db_query_mixin.DbQueryMixin" -> "loki_modules.loki_biofilter.db.Database" [label="Operations"];
"loki_modules.loki_mixins.db_schema_mixin.DbSchemaMixin" -> "loki_modules.loki_biofilter.db.Database" [label="Schema_Operations"];
"loki_modules.loki_mixins.db_schema.DbSchema" -> "loki_modules.loki_biofilter.db.Database" [label="Schema"];
"loki_modules.loki_mixins.db_version_mixin.DbVersion" -> "loki_modules.loki_biofilter.db.Database" [label="Version_Control"];
