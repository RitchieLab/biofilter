            ...
            for srcName in sorted(srcSet):
                ...
                if optionsList:
                    self.logPush(
                        "%s %s options ...\n"
                        % (
                            ("validating" if (srcName in srcOpts) else "loading prior"),
                            srcName,
                        )
                    )
...
"""
        ...
        self.log(
            "resolving biopolymer names completed: %d identifiers (%d ambiguous, %d unrecognized)\n"
...
"""
            ...
            numUnrec = row[4]
        self.log(
            "resolving group members completed: %d associations (%d explicit, %d definite, %d conditional, %d unrecognized)\n"
