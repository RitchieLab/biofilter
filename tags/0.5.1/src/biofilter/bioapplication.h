...
public:
	 ...
	 */
	void InitBiofilter(const char *dbFilename);
	...
	/**
	 * @brief Removes expired RS IDs and remaps RS IDs whose IDs have been changed
	 * @param snps The list of snps the user requested. This will be updated accordingly
	 */
	void CleanRSIDs(std::vector<uint>& snps, const char *rsCleanReport);
	/**
