...
public:
    ...
    * @return
    */
	uint LoadData(const SnpArray& data, uint uscBuildVersion);
    ...
    */
	SnpDataset::SNP& operator[](uint index);
    ...
    */
	...
	void AddSNPs(const SnpArray& snps);
	 ...
	 *		
	 */
	uint ReconcileLiftover(std::multimap<SNP, SNP>& converted, std::ostream& os, int tolerance);
