...
def fake_retriever(query, pool_limit, entity_type_hints):
    ...
    return [
        Candidate(entity_id=1, entity_type="Disease", primary_name="Alzheimer disease",
                  matched_name="Alzheimer disease", method="exact_name",
                  meta={"is_primary_name": True}),
        Candidate(entity_id=2, entity_type="Disease", primary_name="Alzheimer's disease",
                  matched_name="Alzheimer's disease", method="db_pool"),
        Candidate(entity_id=3, entity_type="Gene", primary_name="ALZ",
                  matched_name="ALZ", method="db_pool"),
    ]
